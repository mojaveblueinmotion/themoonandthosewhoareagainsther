...
@section('modal-body')
    ...
    <div style="max-height:600px; overflow-y:auto; width:100%" class="modal-body">
        <input type="hidden" id="loader_id" name="loader_id" value="{{ $record->id ?? 0 }}">
        <div class="row">
            <div class="col-md-6">
        ...
        <input type="hidden" id="sisaSaldoDb" value="{{ App\Models\Tm1\LoaderDetail::where('loader_id', $record->id)->count() ? App\Models\Tm1\LoaderDetail::where('loader_id', $record->id)->orderBy('id', 'desc')->first()->saldo_sisa : 0 }}">
        <input type="hidden" value="{{ App\Models\Tm1\LoaderDetail::where('loader_id', $record->id)->count() }}" id="countDetail">
        <hr>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group row">
