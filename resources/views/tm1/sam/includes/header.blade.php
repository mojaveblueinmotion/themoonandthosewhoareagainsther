...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="form-group row">
            <label class="col-md-2 col-form-label">{{ __('Total Hasil Akhir Keseluruhan') }}</label>
            <div class="col-md-10 parent-group">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text font-weight-bolder">Rp</span>
                    </div>
                    <input type="text" id="get_hasil_akhir" disabled class="form-control base-plugin--inputmask_currency" value="">
                </div>
            </div>
        </div>
    </div>
