    ...
    <tbody>
        @foreach ($data->details as $detail)
            <tr>
                ...
                <td style="border:1px solid black;text-align: center;">{{ number_format($detail->premi_supir) }}</td>
                <td style="border:1px solid black;text-align: center;">{{ number_format($detail->premi_agen) }}</td>
                ...
                @endforelse
                <td style="border:1px solid black;text-align: center;">{{ number_format($detail->pengeluaran_lapak) }}</td>
