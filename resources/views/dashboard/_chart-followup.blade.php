    ...
    <div class="card card-custom card-stretch gutter-b chart-followup-wrapper">
        <div class="card-header h-auto py-3">
            ...
            <div class="card-toolbar" style="max-width: 500px;">
                <form id="filter-chart-followup" action="{{ route($routes . '.chartFollowup') }}" class="form-inline"
                    role="form">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="input-daterange input-group text-nowrap">
                                ...
                                @if ($user->hasRole('Administrator'))
                                    <input class="form-control followup_start" disabled name="followup_start"
                                        value="{{ request()->followup_start ?? date('Y') - 5 }}" style="">
                                @else
                                    <input class="form-control followup_start" name="followup_start"
                                        value="{{ request()->followup_start ?? date('Y') - 5 }}" style="">
                                @endif
                                ...
                                @if ($user->hasRole('Administrator'))
                                    <input class="form-control followup_end" disabled name="followup_end"
                                        value="{{ request()->followup_end ?? date('Y') }}" style="">
                                @else
                                    <input class="form-control followup_end" name="followup_end"
                                        value="{{ request()->followup_end ?? date('Y') }}" style="">
                                @endif
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            @if ($user->hasRole('Administrator'))
                                <select name="followup_object" class="form-control base-plugin--select2 followup_object"
