        ...
        $(function() {
            $('select.complexity,select.volume,select.known_issue,select.chaning_process').change(function(e) {
                ...
                if (me.val()) {
                    ...
                    if (complexity && volume && known_issue && chaning_process) {
                        var total = (complexity * 0.3) + (volume * 0.35) + (known_issue * 0.2) + (
                            chaning_process * 0.15)
            ...
            $('select.materiality,select.legal,select.operational').change(function(e) {
                ...
                if (me.val()) {
                    ...
                    if (materiality && legal && operational) {
