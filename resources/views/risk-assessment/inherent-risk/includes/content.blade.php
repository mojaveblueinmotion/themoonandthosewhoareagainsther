    						...
    						<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group row">
										...
										<div class="col-md-6 parent-group">
											<select required id="volume" name="volume" class="form-control base-plugin--select2 volume"
												placeholder="{{ __('Pilih Salah Satu') }}">
												<option value="">{{ __('Pilih Salah Satu') }}</option>
								...
								<div class="col-md-6">
									<div class="form-group row">
										...
										<div class="col-md-6 parent-group">
											<select required id="known_issue" name="known_issue" class="form-control base-plugin--select2 known_issue"
												placeholder="{{ __('Pilih Salah Satu') }}">
												<option value="">{{ __('Pilih Salah Satu') }}</option>
									...
									<div class="form-group row">
										...
										<div class="col-md-6 parent-group">
											<select required id="chaning_process" name="chaning_process" class="form-control base-plugin--select2 chaning_process"
												placeholder="{{ __('Pilih Salah Satu') }}">
												<option value="">{{ __('Pilih Salah Satu') }}</option>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
										...
										<div class="col-md-6 parent-group">
                                            <input id="total_likehood" type="text" class="form-control" name="total_likehood" value="{{$record->total_likehood ?? ''}}" readonly>
                                        </div>
									</div>
                                </div>
                            </div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="card card-custom">
						...
						@endphp
						@if ($menu = \App\Models\Globals\Menu::where('module',
						'risk-assessment.inherent-risk')->first())
