...
@section('filters')
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-xl-3 mr-n6 pb-2">
            <select data-post="auditee_id" class="form-control filter-control base-plugin--select2-ajax filterUnitKerja"
                id="filterUnitKerja" data-url="{{ rut('ajax.selectStruct', 'department_auditee') }}"
