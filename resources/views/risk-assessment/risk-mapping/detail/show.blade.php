...
@section('modal-body')
    <div class="form-group row">
        ...
        <div class="col-md-9 parent-group">
            <div class="input-group">
                <input disabled name="prosentase" class="form-control angka--persen" placeholder="{{ __('Prosentase') }}"
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9 parent-group">
            <input disabled type="text" name="tgl_realisasi" class="form-control base-plugin--datepicker tgl_realisasi"
                placeholder="{{ __('Tgl Realisasi') }}" value="{{ $detail->tgl_realisasi->format('d/m/Y') }}"
                data-orientation="top" data-options='@json([
