                                            ...
                                            <div class="col-md-8 parent-group">
                                                <select name="type_id" class="form-control base-plugin--select2-ajax type_id"
                                                    ...
                                                    @if ($record->riskRegister)
                                                        <option value="{{ $record->riskRegister->type_id }}" selected>{{ $record->riskRegister->type->name }}</option>
                                                    @endif
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 parent-group">
                                                <select id="unitKerjaCtrl" disabled name="unit_kerja_id"
                                                    class="form-control base-plugin--select2-ajax" data-url="{{ rut('ajax.selectStruct', 'all') }}"
                                                    placeholder="{{ __('Pilih Salah Satu') }}">
                                                    <option value="">{{ __('Pilih Salah Satu') }}</option>
                                                    @if (!empty($record->riskRegister->unitKerja))
                                                        <option value="{{ $record->riskRegister->unitKerja->id }}" selected>
                    ...
                    <div class="col-md-6">
                        <div class="card card-custom">
                            ...
                            <div class="card-body text-center">
                                ...
                                @endphp
                                @if ($menu = \App\Models\Globals\Menu::where('module', $module)->first())
