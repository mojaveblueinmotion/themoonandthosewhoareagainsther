...
@section('filters')
    <div class="row">
        <div class="col-12 col-sm-3 col-xl-1 mr-n6 pb-2">
            <input type="text" class="form-control base-plugin--datepicker-3 filter-control" data-post="periode"
        ...
        <div class="col-12 col-sm-6 col-xl-3 mr-n6 pb-2">
            <select data-post="object_id" id="subject_id" class="form-control filter-control base-plugin--select2-ajax filter-object"
        ...
        <div class="col-12 col-sm-6 col-xl-3 mr-n6 pb-2">
            <select name="auditee_id" data-post="auditee_id" class="form-control filter-control base-plugin--select2-ajax unitKerja" id="unitKerja"
