        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th class="valign-middle text-center" style="width: 100px;">
                ...
                @forelse ($record->flows as $flow)
                    <tr data-key="{{ $loop->iteration }}">
                        ...
                        <td class="parent-group text-left">
                            ...
                            <input type="hidden" name="flows[{{ $loop->iteration }}][type]" value="1">
                        </td>
                        ...
                        {{-- <td class="parent-group text-center">
                            <label class="checkbox checkbox-lg d-inline-block checkbox-rounded">
                                <input type="radio" class="approve check" name="flows[{{ $loop->iteration }}][type]"
                                    value="2" {{ $flow->type == 1 ? '' : 'checked' }}>
                                <span></span>
                            </label>
                        </td> --}}
                        <td class="text-center">
                            <div class="d-flex justify-content-center">
                                ...
                                <button type="button" class="btn btn-circle btn-danger btn-sm btn-icon remove-flow"><i
                ...
                var template = `
	                <tr data-key="` + key + `">
	                    ...
	                    <td class="text-left parent-group">
                            ...
                            <input type="hidden" name="flows[` + key + `][type]" value="1">
	                    </td>
