...
@section('modal-body')
    ...
    <div class="form-group row">
		...
		<div class="col-sm-8 parent-group">
			<select name="roles[]" class="form-control base-plugin--select2-ajax role"
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 parent-group">
			<input type="text" id="nipCtrl" name="npp" class="form-control masking-npp" placeholder="{{ __('NIP') }}">
		</div>
	</div>
	<div class="form-group row">
	...
	<script>
		...
		$(function () {
			...
			.on('change', '#strukturCtrl', function(){
                ...
                var me = $(this);
                if(me.val() == 1 ) {
                        $('#jabatanCtrl').prop('disabled',true);
                        $('#strukturCtrl').prop('disabled',true);
                        $('#nipCtrl').prop('disabled',true);
                } else {
                    $('#jabatanCtrl').prop('disabled',false);
                        $('#strukturCtrl').prop('disabled',false);
                        $('#nipCtrl').prop('disabled',false);
                }
