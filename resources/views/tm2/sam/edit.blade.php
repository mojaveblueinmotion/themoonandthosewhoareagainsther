...
@section('modal-body')
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8 parent-group">
            <input type="hidden" name="perusahaan_id" value="{{ App\Models\Master\Pembukuan\Lapak::where('id', 2)->first()->id }}">
            <select disabled name="perusahaan_id" data-post="perusahaan_id" class="form-control filter-control base-plugin--select2-ajax perusahaan_id"
                ...
                <option value="2" selected>{{ App\Models\Master\Pembukuan\Lapak::where('id',2)->first()->name }}</option>
            </select>
        </div>
    </div>
    <div class="form-group row">
