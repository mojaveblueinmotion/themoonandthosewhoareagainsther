            ...
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 parent-group">
                        <input disabled value="{{ $detail->supplier }}" type="text" name="vendor" class="form-control" value=""
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 parent-group">
                        <div class="input-group">
                            ...
                            <input disabled value="{{ $detail->fee_agen_bruto }}" class="form-control base-plugin--inputmask_currency fee_agen_bruto" id="fee_agen_bruto" name="fee_agen_bruto"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 parent-group">
                        <div class="input-group">
                            ...
                            <input disabled value="{{ $detail->fee_agen }}" class="form-control base-plugin--inputmask_currency fee_agen" id="fee_agen" name="fee_agen"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10 parent-group">
                        <div class="input-group">
                            ...
                            <input disabled value="{{ $detail->hasil_akhir }}" class="form-control base-plugin--inputmask_currency hasil_akhir" id="hasil_akhir" name="hasil_akhir"
