...
@section('modal-body')
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9 parent-group">
            <input type="text" name="procedure" class="form-control" id="nameCtrl" maxlength="255"
                placeholder="{{ __('Nama') }}">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-md-9 parent-group">
            <input type="text" name="mandays" class="form-control" oninput="validateNumericInput(this)"
                placeholder="{{ __('Mandays') }}">
        </div>
    </div>
    <div class="form-group row">
        <label class="col-md-3 col-form-label">{{ __('Nomor') }}</label>
        <div class="col-md-9 parent-group">
            <input min="1" type="number" name="number" class="form-control"
                placeholder="{{ __('Nomor Urut') }}" oninput="this.value = Math.abs(this.value)">
        </div>
    </div>
    <div class="form-group row">
