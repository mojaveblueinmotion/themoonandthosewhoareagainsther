...
<div class="form-group row">
    ...
    <div class="col-sm-9 parent-group text-right">
        <input disabled value="{{ $record->year }}" type="text" name="year" class="form-control base-plugin--datepicker-3 width-100px ml-auto text-right" placeholder="{{ __('Tahun') }}">
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-sm-9 parent-group">
        <select disabled name="type_id" class="form-control filter-control base-plugin--select2-ajax type_id"
            ...
            <option selected value="{{ $record->type->id }}">{{ $record->type->name }}</option>
        </select>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-sm-9 parent-group">
        <select disabled name="subject_id" id="subjectAudit" class="form-control base-plugin--select2-ajax subjectAudit"
            data-url="{{ rut('ajax.selectStruct', ['search' => 'subject', 'type_id' => '']) }}"
            data-url-origin="{{ rut('ajax.selectStruct', 'subject') }}" disabled
            placeholder="{{ __('Pilih Salah Satu') }}">
            <option selected value="{{ $record->subject->id }}">{{ $record->subject->name }}</option>
        </select>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-md-9 parent-group">
        <select disabled name="departments[]" class="form-control base-plugin--select2-ajax"
            data-url="{{ route('ajax.selectStruct', [
                'search' => 'parent_division',
            ]) }}"
