...
@section('modal-body')
    ...
    <div class="form-group row">
		...
		<div class="col-sm-9 parent-group text-right">
			<input value="{{ $record->year }}" type="text" name="year" class="form-control base-plugin--datepicker-3 width-100px ml-auto text-right" placeholder="{{ __('Tahun') }}">
		</div>
	</div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9 parent-group">
            <input type="hidden" name="subject_id" value="{{ $record->subject_id }}">
