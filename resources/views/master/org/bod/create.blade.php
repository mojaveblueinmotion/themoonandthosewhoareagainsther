...
@section('modal-body')
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 parent-group">
            <select name="parent_id" class="form-control base-plugin--select2-ajax"
                data-url="{{ rut('ajax.selectStruct', 'parent_bod') }}" data-placeholder="{{ __('Pilih Salah Satu') }}">
            </select>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 parent-group">
            <input id="codeCtrl" type="text" name="code" class="form-control" placeholder="{{ __('Kode') }}" oninput="validateInput(this)">
        </div>
    </div>
    <div class="form-group row">
