...
@section('card-body')
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="form-group row">
				...
				<div class="col-md-8 parent-group">
					<select name="object_id" class="form-control base-plugin--select2-ajax object_id"
						data-url="{{ rut('ajax.selectObject', ['category'=>'']) }}"
			...
			<div class="form-group row">
				...
				<div class="col-md-8 parent-group">
					<input type="text" name="key" class="form-control" placeholder="{{ __('Key Activities') }}">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="table-responsive">
		<table class="table table-bordered">
			...
			<tbody>
				<tr data-key="1">
					<td class="text-center width-60px no">1</td>
					<td class="text-left parent-group">
						<input type="text" name="details[1][description]"
							class="form-control"
							placeholder="{{ __('Detail') }}">
					</td>
					<td class="text-left width-200px parent-group">
						<select name="details[1][risk_rating_id]"
					...
					<td class="text-left parent-group">
						<textarea name="details[1][source]"
							class="form-control"
