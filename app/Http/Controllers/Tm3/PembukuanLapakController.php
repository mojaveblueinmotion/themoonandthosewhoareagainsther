...
namespace App\Http\Controllers\Tm3;
...
{
    protected $module = 'tm3.lapak';
    protected $routes = 'tm3.lapak';
    protected $views = 'tm3.lapak';
    protected $perms = 'tm3.lapak';
