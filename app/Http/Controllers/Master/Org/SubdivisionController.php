...
use App\Http\Requests\Master\Org\SubdivisionRequest;
use App\Models\Master\Org\OrgStruct;
use Illuminate\Http\Request;

class SubdivisionController extends Controller
{
    protected $module = 'master.org.subdivision';
    protected $routes = 'master.org.subdivision';
    protected $views = 'master.org.subdivision';
    ...
    public function __construct()
    {
        $this->prepare([
            ...
            'breadcrumb' => [
                ...
                'Sub Divisi' => rut($this->routes . '.index'),
            ]
        ]);
    }
    ...
    {
        $user = auth()->user();
        $records = OrgStruct::Subdivision()->filters()->dtGet();
    ...
    public function store(SubdivisionRequest $request)
    {
        ...
        return $record->handleStoreOrUpdate($request, 'subdivision');
    }
    ...
    public function update(SubdivisionRequest $request, OrgStruct $record)
    {
        return $record->handleStoreOrUpdate($request, 'subdivision');
    }
